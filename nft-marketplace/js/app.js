...
***************************************************************************** */
    ...
    let deadline = new Date("2023-03-01").getTime();
    if (localStorage.getItem("deadline")) deadline = localStorage.getItem("deadline"); else localStorage.setItem("deadline", deadline);
    const x = setInterval((function() {
        ...
        if (distance < 0) {
            clearInterval(x);
            document.querySelector(".timer__items").innerHTML = "EXPIRED";
        }
    }), 1e3);
